...
private:
  ...
  bool DetectNearestKeyFrameScanContext(int &key_frame_index);
  ...
  bool Registration(CloudData::CLOUD_PTR &map_cloud_ptr, CloudData::CLOUD_PTR &scan_cloud_ptr,
